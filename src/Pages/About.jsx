      ...
      <div>
        <div className=" py-5">
          ...
          <div className="flex justify-center">
            <p className="text-accent text-justify px-62 ">
              Pet care is the process of tending to the health, well-being, and
              comfort of domestic animals through providing proper nutrition,
              clean water, safe shelter, and necessary medical attention. It
              also includes regular grooming, sufficient exercise, mental
              stimulation, and training to ensure a pet is healthy and lives a
              long, happy life.
            </p>
          </div>
        </div>
